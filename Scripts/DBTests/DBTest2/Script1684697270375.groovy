...
connection = CustomKeywords.'com.katalon.plugin.keyword.connection.DatabaseKeywords.createConnection'(DBType.postgresql, '192.168.1.133', 
    '5432', 'rental', 'rentaladmin', 'cmVudGFsYWRtaW4=')
