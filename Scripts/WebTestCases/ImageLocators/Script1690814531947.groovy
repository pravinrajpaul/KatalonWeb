...
WebUI.verifyElementVisible(findTestObject('Object Repository/ImageLocators/Page_OrangeHRM/img'))

WebUI.setText(findTestObject('Object Repository/ImageLocators/Page_OrangeHRM/input_Username_username'), 'Admin')
